...
# para = sys.argv
INF = int(1e9 + 7)
para = [None, 500, 5, 300, 128, 1, 0.01, 0.03, 4, 2, 10]
re = [1, 10, 100, 500] # recall的输出值
ef = [#4, 8, 12, 16, 32, 64, 128, 256, 
      500, 800, 1000, 2000, 3000, 4000, 
      5000, 7000, 9000, 11000, 13000, 15000] # efsearch的输出值
...
if __name__ == '__main__':
    ...
    # 添加节点
    print("add, size", xb.shape)
    t1 = time.time()
    index.add(xb)
    print("  add in %.3f s" % (time.time() - t1))
