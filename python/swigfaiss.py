...
class ProductQuantizer(object):
    ...
    byte_per_idx = property(_swigfaiss.ProductQuantizer_byte_per_idx_get, _swigfaiss.ProductQuantizer_byte_per_idx_set)
...
class ConcatenatedInvertedLists(InvertedLists):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ils = property(_swigfaiss.ConcatenatedInvertedLists_ils_get, _swigfaiss.ConcatenatedInvertedLists_ils_set)

    def __init__(self, nil, ils):
        _swigfaiss.ConcatenatedInvertedLists_swiginit(self, _swigfaiss.new_ConcatenatedInvertedLists(nil, ils))
...
# Register ConcatenatedInvertedLists in _swigfaiss:
_swigfaiss.ConcatenatedInvertedLists_swigregister(ConcatenatedInvertedLists)
...
class HNSW(object):
    ...
    maxInDegree = property(_swigfaiss.HNSW_maxInDegree_get, _swigfaiss.HNSW_maxInDegree_set)
    splitRate = property(_swigfaiss.HNSW_splitRate_get, _swigfaiss.HNSW_splitRate_set)
    index1 = property(_swigfaiss.HNSW_index1_get, _swigfaiss.HNSW_index1_set)
    index2 = property(_swigfaiss.HNSW_index2_get, _swigfaiss.HNSW_index2_set)
    search_bounded_queue = property(_swigfaiss.HNSW_search_bounded_queue_get, _swigfaiss.HNSW_search_bounded_queue_set)
    hot_hubs = property(_swigfaiss.HNSW_hot_hubs_get, _swigfaiss.HNSW_hot_hubs_set)
...
class IndexHNSW(Index):
    ...
    f_storage = property(_swigfaiss.IndexHNSW_f_storage_get, _swigfaiss.IndexHNSW_f_storage_set)
    s_storage = property(_swigfaiss.IndexHNSW_s_storage_get, _swigfaiss.IndexHNSW_s_storage_set)
    vct = property(_swigfaiss.IndexHNSW_vct_get, _swigfaiss.IndexHNSW_vct_set)
...
class IndexShards(Index):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    shard_indexes = property(_swigfaiss.IndexShards_shard_indexes_get, _swigfaiss.IndexShards_shard_indexes_set)
    own_fields = property(_swigfaiss.IndexShards_own_fields_get, _swigfaiss.IndexShards_own_fields_set)
    threaded = property(_swigfaiss.IndexShards_threaded_get, _swigfaiss.IndexShards_threaded_set)
    ...
    def __init__(self, d, threaded=False, successive_ids=True):
        _swigfaiss.IndexShards_swiginit(self, _swigfaiss.new_IndexShards(d, threaded, successive_ids))
