...
class HNSW(_object):
    ...
    __swig_setmethods__["maxInDegree"] = _swigfaiss.HNSW_maxInDegree_set
    __swig_getmethods__["maxInDegree"] = _swigfaiss.HNSW_maxInDegree_get
    if _newclass:
        maxInDegree = _swig_property(_swigfaiss.HNSW_maxInDegree_get, _swigfaiss.HNSW_maxInDegree_set)
    __swig_setmethods__["splitRate"] = _swigfaiss.HNSW_splitRate_set
    __swig_getmethods__["splitRate"] = _swigfaiss.HNSW_splitRate_get
    if _newclass:
        splitRate = _swig_property(_swigfaiss.HNSW_splitRate_get, _swigfaiss.HNSW_splitRate_set)
    __swig_setmethods__["index1"] = _swigfaiss.HNSW_index1_set
    __swig_getmethods__["index1"] = _swigfaiss.HNSW_index1_get
    if _newclass:
        index1 = _swig_property(_swigfaiss.HNSW_index1_get, _swigfaiss.HNSW_index1_set)
    __swig_setmethods__["index2"] = _swigfaiss.HNSW_index2_set
    __swig_getmethods__["index2"] = _swigfaiss.HNSW_index2_get
    if _newclass:
        index2 = _swig_property(_swigfaiss.HNSW_index2_get, _swigfaiss.HNSW_index2_set)
    ...
    __swig_setmethods__["hot_hubs"] = _swigfaiss.HNSW_hot_hubs_set
    __swig_getmethods__["hot_hubs"] = _swigfaiss.HNSW_hot_hubs_get
    if _newclass:
        hot_hubs = _swig_property(_swigfaiss.HNSW_hot_hubs_get, _swigfaiss.HNSW_hot_hubs_set)
    ...
    def add_links_starting_from(self, ptdis, pt_id, nearest, d_nearest, level, locks, vt, temp_n):
        return _swigfaiss.HNSW_add_links_starting_from(self, ptdis, pt_id, nearest, d_nearest, level, locks, vt, temp_n)
    ...
    def find_hot_hubs(self, ses, n, ratios):
        return _swigfaiss.HNSW_find_hot_hubs(self, ses, n, ratios)

    def find_hot_hubs_with_neighbors(self, ses, n, ratios):
        return _swigfaiss.HNSW_find_hot_hubs_with_neighbors(self, ses, n, ratios)

    def find_hot_hubs_with_classfication(self, ses, n, ratios, clsf):
        return _swigfaiss.HNSW_find_hot_hubs_with_classfication(self, ses, n, ratios, clsf)

    def find_hot_hubs_enhence(self, hot_hubs, n, ratios, find_hubs_mode, find_neighbors_mode):
        return _swigfaiss.HNSW_find_hot_hubs_enhence(self, hot_hubs, n, ratios, find_hubs_mode, find_neighbors_mode)

    def hot_hubs_new_neighbors(self, ses, hot_hubs, n, find_neighbors_mode):
        return _swigfaiss.HNSW_hot_hubs_new_neighbors(self, ses, hot_hubs, n, find_neighbors_mode)

    def fromNearestToFurther(self, nb_reverse_nbs_level, new_neibor, dis, hot_hub):
        return _swigfaiss.HNSW_fromNearestToFurther(self, nb_reverse_nbs_level, new_neibor, dis, hot_hub)

    def shink_reverse_neighbors(self, nb_reverse_nbs_level, new_neibor, dis, hot_hub, n):
        return _swigfaiss.HNSW_shink_reverse_neighbors(self, nb_reverse_nbs_level, new_neibor, dis, hot_hub, n)

    def add_new_reverse_link_end_enhence(self, hot_hubs, n, dis, nb_reverse_neighbors):
        return _swigfaiss.HNSW_add_new_reverse_link_end_enhence(self, hot_hubs, n, dis, nb_reverse_neighbors)

    def add_links_to_hubs(self, hot_hubs, n):
        return _swigfaiss.HNSW_add_links_to_hubs(self, hot_hubs, n)

    def find_hot_hubs_enhence_subIndex(self, hot_hubs, n, ratios, find_hubs_mode, find_neighbors_mode):
        return _swigfaiss.HNSW_find_hot_hubs_enhence_subIndex(self, hot_hubs, n, ratios, find_hubs_mode, find_neighbors_mode)

    def hot_hubs_new_neighbors_subIndex(self, ses, hot_hubs, n, find_neighbors_mode):
        return _swigfaiss.HNSW_hot_hubs_new_neighbors_subIndex(self, ses, hot_hubs, n, find_neighbors_mode)
    ...
    def search_from_addk(self, node, qdis, ef, vt, k):
        return _swigfaiss.HNSW_search_from_addk(self, node, qdis, ef, vt, k)

    def search_from_addk_v2(self, node, qdis, ef, vt, k):
        return _swigfaiss.HNSW_search_from_addk_v2(self, node, qdis, ef, vt, k)

    def search_rt_array(self, qdis, k, I, D, vt, vct):
        return _swigfaiss.HNSW_search_rt_array(self, qdis, k, I, D, vt, vct)

    def search_from_add_vct(self, node, qdis, ef, vt, vct):
        return _swigfaiss.HNSW_search_from_add_vct(self, node, qdis, ef, vt, vct)

    def similarity(self, index1, index2, nb):
        return _swigfaiss.HNSW_similarity(self, index1, index2, nb)

    def setIndex(self, index1, index2):
        return _swigfaiss.HNSW_setIndex(self, index1, index2)

    def search(self, qdis, k, I, D, vt):
        return _swigfaiss.HNSW_search(self, qdis, k, I, D, vt)

    def search_custom(self, qdis, k, I, D, vt, search_mode):
        return _swigfaiss.HNSW_search_custom(self, qdis, k, I, D, vt, search_mode)

    def combine_search(self, qdis, k, I, D, fos, vt, rng3):
        return _swigfaiss.HNSW_combine_search(self, qdis, k, I, D, fos, vt, rng3)

    def search_from_candidates_combine(self, qdis, k, I, D, candidates, vt, level, nres_in, fos):
        return _swigfaiss.HNSW_search_from_candidates_combine(self, qdis, k, I, D, candidates, vt, level, nres_in, fos)

    def search_from_candidate_unbounded_combine(self, node, qdis, ef, vt, fos):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_combine(self, node, qdis, ef, vt, fos)

    def search_from_candidate_unbounded_hot_hubs_enhence(self, node, qdis, ef, vt, n):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_hot_hubs_enhence(self, node, qdis, ef, vt, n)

    def search_from_candidates_hot_hubs(self, qdis, k, I, D, candidates, vt, level, nres_in, n):
        return _swigfaiss.HNSW_search_from_candidates_hot_hubs(self, qdis, k, I, D, candidates, vt, level, nres_in, n)

    def search_with_hot_hubs_enhence(self, qdis, k, I, D, vt, n, rng3):
        return _swigfaiss.HNSW_search_with_hot_hubs_enhence(self, qdis, k, I, D, vt, n, rng3)

    def search_from_candidate_unbounded_hot_hubs_enhence_random(self, node, qdis, ef, vt, n):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_hot_hubs_enhence_random(self, node, qdis, ef, vt, n)

    def search_from_candidate_unbounded_hot_hubs_enhence_random_v2(self, node, qdis, ef, vt, n):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_hot_hubs_enhence_random_v2(self, node, qdis, ef, vt, n)

    def search_from_candidate_unbounded_hot_hubs_enhence_random_v3(self, node, qdis, ef, vt, n):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_hot_hubs_enhence_random_v3(self, node, qdis, ef, vt, n)

    def search_with_hot_hubs_enhence_random(self, qdis, k, I, D, vt, n, rng3):
        return _swigfaiss.HNSW_search_with_hot_hubs_enhence_random(self, qdis, k, I, D, vt, n, rng3)
    ...
    def prepare_level_tab2(self, n, preset_levels=False):
        return _swigfaiss.HNSW_prepare_level_tab2(self, n, preset_levels)

    def prepare_level_tab3(self, index1, n, tmp, preset_levels=False):
        return _swigfaiss.HNSW_prepare_level_tab3(self, index1, n, tmp, preset_levels)

    def prepare_level_tab4(self, n, tmp):
        return _swigfaiss.HNSW_prepare_level_tab4(self, n, tmp)

    def shrink_neighbor_list(self, qdis, input, output, max_size, split, level):
        return _swigfaiss.HNSW_shrink_neighbor_list(self, qdis, input, output, max_size, split, level)

    def getSearchDis(self):
        return _swigfaiss.HNSW_getSearchDis(self)

    def getSearchDisFlat(self):
        return _swigfaiss.HNSW_getSearchDisFlat(self)

    def resetCount(self):
        return _swigfaiss.HNSW_resetCount(self)

    def getHotSet(self, n, len_ratios, ht_hbs_ratios):
        return _swigfaiss.HNSW_getHotSet(self, n, len_ratios, ht_hbs_ratios)

    def getHothubsSearchCount(self):
        return _swigfaiss.HNSW_getHothubsSearchCount(self)

    def initHothubSearchmp(self):
        return _swigfaiss.HNSW_initHothubSearchmp(self)

    def statichotpercent(self, n):
        return _swigfaiss.HNSW_statichotpercent(self, n)

    def statcihotlinknums(self, n):
        return _swigfaiss.HNSW_statcihotlinknums(self, n)

    def getKnn(self, qdis, id, n, k, initial_list):
        return _swigfaiss.HNSW_getKnn(self, qdis, id, n, k, initial_list)
    ...
    def static_in_degree_by_direct(self, n, qdis):
        return _swigfaiss.HNSW_static_in_degree_by_direct(self, n, qdis)

    def print_time(self, n):
        return _swigfaiss.HNSW_print_time(self, n)

    def print_nb_in_degree(self, n, m, dataName, _type):
        return _swigfaiss.HNSW_print_nb_in_degree(self, n, m, dataName, _type)

    def print_nb_in_degree_hot(self, n, m, dataName, _type):
        return _swigfaiss.HNSW_print_nb_in_degree_hot(self, n, m, dataName, _type)

    def get_computer_count(self):
        return _swigfaiss.HNSW_get_computer_count(self)

    def search_from_candidate_unbounded_hot_hubs_enhence_s(self, candidates, qdis, ef, vt, n):
        return _swigfaiss.HNSW_search_from_candidate_unbounded_hot_hubs_enhence_s(self, candidates, qdis, ef, vt, n)
...
class IndexHNSW(Index):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["dis_method"] = _swigfaiss.IndexHNSW_dis_method_set
    __swig_getmethods__["dis_method"] = _swigfaiss.IndexHNSW_dis_method_get
    if _newclass:
        dis_method = _swig_property(_swigfaiss.IndexHNSW_dis_method_get, _swigfaiss.IndexHNSW_dis_method_set)
    ...
    __swig_setmethods__["search_mode"] = _swigfaiss.IndexHNSW_search_mode_set
    __swig_getmethods__["search_mode"] = _swigfaiss.IndexHNSW_search_mode_get
    if _newclass:
        search_mode = _swig_property(_swigfaiss.IndexHNSW_search_mode_get, _swigfaiss.IndexHNSW_search_mode_set)
    ...
    __swig_setmethods__["f_storage"] = _swigfaiss.IndexHNSW_f_storage_set
    __swig_getmethods__["f_storage"] = _swigfaiss.IndexHNSW_f_storage_get
    if _newclass:
        f_storage = _swig_property(_swigfaiss.IndexHNSW_f_storage_get, _swigfaiss.IndexHNSW_f_storage_set)
    __swig_setmethods__["s_storage"] = _swigfaiss.IndexHNSW_s_storage_set
    __swig_getmethods__["s_storage"] = _swigfaiss.IndexHNSW_s_storage_get
    if _newclass:
        s_storage = _swig_property(_swigfaiss.IndexHNSW_s_storage_get, _swigfaiss.IndexHNSW_s_storage_set)
    __swig_setmethods__["vct"] = _swigfaiss.IndexHNSW_vct_set
    __swig_getmethods__["vct"] = _swigfaiss.IndexHNSW_vct_get
    if _newclass:
        vct = _swig_property(_swigfaiss.IndexHNSW_vct_get, _swigfaiss.IndexHNSW_vct_set)
    ...
    def get_distance_computer(self, *args):
        return _swigfaiss.IndexHNSW_get_distance_computer(self, *args)
    ...
    def final_top_100(self, simi, idxi, simi1, idxi1, simi2, idxi2, dis1, dis2, k):
        return _swigfaiss.IndexHNSW_final_top_100(self, simi, idxi, simi1, idxi1, simi2, idxi2, dis1, dis2, k)

    def combine_search(self, n, x, y, k, distances, labels, distances1, labels1, distances2, labels2):
        return _swigfaiss.IndexHNSW_combine_search(self, n, x, y, k, distances, labels, distances1, labels1, distances2, labels2)

    def combine_index_with_hot_hubs_enhence(self, n, len_ratios, ht_hbs_ratios, find_hubs_mode, find_neighbors_mode, max_rvs_nb_per_level):
        return _swigfaiss.IndexHNSW_combine_index_with_hot_hubs_enhence(self, n, len_ratios, ht_hbs_ratios, find_hubs_mode, find_neighbors_mode, max_rvs_nb_per_level)

    def search_with_hot_hubs_enhence(self, n, x, k, distances, labels, xb_size):
        return _swigfaiss.IndexHNSW_search_with_hot_hubs_enhence(self, n, x, k, distances, labels, xb_size)

    def enhence_index_with_subIndex_hubs(self, n, len_ratios, ht_hbs_ratios, find_hubs_mode, find_neighbors_mode, nb_nbors_per_level, ihf1, ihf2, ihf3, ihf4, ihf5, idxScript1, idxScript2, idxScript3, idxScript4, idxScript5):
        return _swigfaiss.IndexHNSW_enhence_index_with_subIndex_hubs(self, n, len_ratios, ht_hbs_ratios, find_hubs_mode, find_neighbors_mode, nb_nbors_per_level, ihf1, ihf2, ihf3, ihf4, ihf5, idxScript1, idxScript2, idxScript3, idxScript4, idxScript5)

    def search_with_hot_hubs_enhence_random(self, n, x, k, distances, labels, xb_size):
        return _swigfaiss.IndexHNSW_search_with_hot_hubs_enhence_random(self, n, x, k, distances, labels, xb_size)

    def complete_random_hot_hubs_enhence(self, n, x, len_ratios, ht_hbs_ratios, nb_nbors_per_level, cls):
        return _swigfaiss.IndexHNSW_complete_random_hot_hubs_enhence(self, n, x, len_ratios, ht_hbs_ratios, nb_nbors_per_level, cls)

    def aod_level(self):
        return _swigfaiss.IndexHNSW_aod_level(self)
    ...
    def createKnn(self, n, k):
        return _swigfaiss.IndexHNSW_createKnn(self, n, k)

    def static_in_degree_by_direct(self, n):
        return _swigfaiss.IndexHNSW_static_in_degree_by_direct(self, n)
